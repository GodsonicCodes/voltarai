...
import {
  aiStrategyFormSchema,
  type AIStrategyFormData,
} from "@/schema/ai-strategy.schema";
...
const AIStrategyForm: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  const [errors, setErrors] = useState<
    Partial<Record<keyof AIStrategyFormData, string>>
  >({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { error, value } = aiStrategyFormSchema.validate(formData, {
      abortEarly: false,
    });
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-white max-w-xl w-full min-h-[90dvh] max-h-[90dvh] md:max-h-[100dvh]] overflow-y-auto shadow-2xl rounded-lg"
      >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <Select
                    ...
                    setValue={(value) =>
                      updateField("businessChallenge", value)
                    }
                    placeholder="Select your primary challenge"
                    error={errors.businessChallenge}
                  >
                    <option value="operational_inefficiencies">
                      Operational Inefficiencies
                    </option>
                    <option value="high_operational_costs">
                      High Operational Costs
                    </option>
                    <option value="slow_customer_service">
                      Slow Customer Service
                    </option>
                    <option value="data_management_issues">
                      Data Management Issues
                    </option>
                    <option value="lack_automation">Lack of Automation</option>
                    <option value="scaling_challenges">
                      Scaling Challenges
                    </option>
