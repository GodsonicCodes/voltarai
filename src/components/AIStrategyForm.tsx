...
const AIStrategyForm: React.FC<{ onClose?: () => void }> = ({ onClose }) => {
  ...
  return (
    ...
    >
      ...
      >
        {showSuccessForm ? (
          // Success Form Content - Same Container
          <div className="p-6" ref={parentRef}>
            ...
            >
              <p className="text-gray-600 leading-relaxed max-w-md mx-auto">
                Thanks, we have received your request. Our team will contact you within 24-48 hours
              </p>
            </motion.div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center">
                <p className="text-xs text-gray-500">
                  ✓ Free consultation with no obligations<br />
                  ✓ Custom AI strategy delivered in 24 hours<br />
