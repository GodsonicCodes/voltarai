  ...
  return (
    <section className="relative max-w-screen min-h-screen pt-44 flex flex-col justify-center items-center px-6 overflow-hidden bg-black text-white">
      ...
      <motion.img
        src="/line.svg"
        alt="corner line"
        className="absolute top-[6%] left-[6%] sm:top-[5%] sm:left-[5%] md:top-[4%] md:left-[4%] lg:top-[3%] lg:left-[3%] w-[clamp(4rem,8vw,12rem)] opacity-40"
      ...
      <motion.img
        src="/line.svg"
        alt="corner line"
        className="absolute top-[6%] right-[6%] sm:top-[5%] sm:right-[5%] md:top-[4%] md:right-[4%] lg:top-[3%] lg:right-[3%] w-[clamp(4rem,8vw,12rem)] rotate-80 opacity-40"
        initial={{ opacity: 0, scale: 0.9 }}
        animate={{ opacity: [0.25, 0.5, 0.25], scale: [0.95, 1, 0.95] }}
      ...
      <motion.img
        src="/line.svg"
        alt="corner line"
        className="absolute bottom-[6%] left-[6%] sm:bottom-[5%] sm:left-[5%] md:bottom-[2%] md:left-[4%] lg:bottom-[3%] lg:left-[3%] w-[clamp(4rem,8vw,12rem)] -rotate-90 opacity-40"
        initial={{ opacity: 0, scale: 0.9 }}
        animate={{ opacity: [0.25, 0.5, 0.25], scale: [0.95, 1, 0.95] }}
      ...
      <motion.img
        src="/line.svg"
        alt="corner line"
        className="absolute bottom-[6%] right-[6%] sm:bottom-[5%] sm:right-[5%] md:bottom-[2%] md:right-[4%] lg:bottom-[3%] lg:right-[3%] w-[clamp(4rem,8vw,12rem)] rotate-170 opacity-40"
        initial={{ opacity: 0, scale: 0.9 }}
        animate={{ opacity: [0.25, 0.5, 0.25], scale: [0.95, 1, 0.95] }}
