...
const ContactForm: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { error, value } = contactFormSchema.validate(formData, {
      abortEarly: false,
    });
  ...
  const handleStep1Next = () => {
    ...
    const { error } = personalDetailsSchema.validate(personalData, {
      abortEarly: false,
    });
    if (error) {
      const fieldErrors: Partial<Record<keyof ContactFormData, string>> = {};
  ...
  const handleStep2Next = () => {
    ...
    const { error } = organizationDetailsSchema.validate(organizationData, {
      abortEarly: false,
    });
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        value={formData.role}
                        setValue={(value) => updateField("role", value)}
                        error={errors.role}
                      />
                    </div>
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        setValue={(value) => updateField("industry", value)}
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        setValue={(value) =>
                          updateField("organizationWebsite", value)
                        }
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        setValue={(value) =>
                          updateField("organizationSize", value)
                        }
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        setValue={(value) =>
                          updateField("projectBudget", value)
                        }
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        setValue={(value) =>
                          updateField("howDidYouFindUs", value)
                        }
