...
export default function Step1({ formData, updateFormData, onNext }: StepProps) {
    ...
    const handleNext = () => {
        ...
        if (!formData.traineeType) newErrors.traineeType = "Please select trainee type";
    ...
    return (
        <div className="space-y-6">
            <div className="mb-8">
                ...
                <p className="text-gray-500 text-sm">Tell us about yourself or your team</p>
            </div>
            ...
            <FormSelect
                ...
                onChange={(e) => updateFormData({ traineeType: e.target.value as any })}
                options={[
