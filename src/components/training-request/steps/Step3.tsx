...
export default function Step3({
  ...
  const handleSubmit = async () => {
    ...
    if (!formData.goalsExpectations.trim()) {
      newErrors.goalsExpectations =
        "Please provide your goals and expectations";
    }
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          onChange={(e) =>
            updateFormData({ goalsExpectations: e.target.value })
          }
        />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <FormSelect
          ...
          onChange={(e) =>
            updateFormData({ howDidYouHearAboutUs: e.target.value })
          }
          options={[
