...
export default function Step2({ formData, updateFormData, onNext, onBack }: StepProps) {
    ...
    const handleNext = () => {
        ...
        if (!formData.trainingFocus) newErrors.trainingFocus = "Please select a training focus";
        if (!formData.currentKnowledgeLevel) newErrors.currentKnowledgeLevel = "Please select current level";
        if (!formData.preferredFormat) newErrors.preferredFormat = "Please select preferred format";
        if (!formData.estimatedParticipants) newErrors.estimatedParticipants = "Please estimate participants";
    ...
    return (
        <div className="space-y-6">
            <div className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 mb-2">Training Details</h2>
                <p className="text-gray-500 text-sm">Help us understand your training needs</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <FormSelect
                    ...
                    options={[
                        ...
                        { value: "AI Development & Coding", label: "AI Development & Coding" },
                        { value: "AI for Marketing/Sales", label: "AI for Marketing/Sales" },
                        { value: "Custom Business Use Case", label: "Custom Business Use Case" },
                    ]}
                ...
                <FormSelect
                    ...
                    onChange={(e) => updateFormData({ currentKnowledgeLevel: e.target.value })}
                    options={[
                ...
                <FormSelect
                    ...
                    onChange={(e) => updateFormData({ preferredFormat: e.target.value as any })}
                    options={[
                ...
                <FormSelect
                    ...
                    onChange={(e) => updateFormData({ estimatedParticipants: e.target.value })}
                    options={[
