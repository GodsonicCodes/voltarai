        ...
        <div className="relative z-10 border border-white/20 rounded-lg flex flex-col h-full px-4 pt-6 pb-6">
            ...
            <div className="absolute inset-0">
              <Image
                src={
                  imageError
                    ? "/assets/seats.jpg"
                    : event.hero_image_url || "/assets/seats.jpg"
                }
                alt={event.title}
                fill
          ...
          <div className="text-gray-300 text-sm mb-4 line-clamp-3 grow">
            <ReactMarkdown
              components={{
                ...
                blockquote: ({ ...props }) => (
                  <blockquote
                    className="text-gray-300 border-l-4 border-gray-500 pl-2 italic"
                    {...props}
                  />
                ),
                code: ({ ...props }) => (
                  <code
                    className="text-white bg-gray-800 px-1 py-0.5 rounded text-xs"
                    {...props}
                  />
                ),
              }}
          ...
          <div className="space-y-2 mb-4">
            ...
            <div className="flex items-center gap-2 text-gray-400 text-sm">
              ...
              <span>
                {event.start_time || "18:30"} - {event.end_time || "20:30"} (
                {event.timezone || "UTC"})
              </span>
            </div>
            <div className="flex items-center gap-2 text-gray-400 text-sm">
