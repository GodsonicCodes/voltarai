    ...
    const fetchEvents = async () => {
      try {
        ...
        if (allResult.success && allResult.events) {
          ...
          const pastEvents = allResult.events.filter(
    ...
    <section className="py-20 md:max-w-[70%] mx-auto bg-bgBlack px-2 sm:px-4 overflow-hidden">
      ...
      >
        ...
        <p className="text-gray-300 text-lg md:text-xl max-w-3xl mx-auto">
          Join us for exciting AI events, workshops, and conferences. Connect
          with industry experts and discover the future of artificial
          intelligence.
        </p>
      </motion.div>
